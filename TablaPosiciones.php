        ...
        <div class="row">
          ...
          <div class="col" style="text-align: center;background-image: url(img/Inicio.jpg); background-position: center;">
            ...
            <?php
              ...
              $res=$con->query("select * from posiciones order by PTS desc");
              ...
              {
                echo '<tr><td>'.$registro[0].'</td><td>'.$registro[1].'</td><td>'.$registro[2].'</td><td>'.$registro[3].'</td><td>'.$registro[4].'</td><td>'.$registro[5].'</td><td>'.$registro[6].'</td><td>'.$registro[7].'</td></tr>';
              }
              $con->close();
              echo '</table>'
